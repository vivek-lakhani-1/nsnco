    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(default='NONE', on_delete=django.db.models.deletion.DO_NOTHING, related_name='Project_Table', to='Artist_Project.project_table')),
            ],
        ),
    ]
