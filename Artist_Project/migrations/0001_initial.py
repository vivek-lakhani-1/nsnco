    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_artist', models.ManyToManyField(blank=True, null=True, related_name='ArtistTable4', to='Artist.artisttable')),
                ...
                ('project_demo', models.ManyToManyField(blank=True, null=True, related_name='ProjectDemos2', to='Artist.projectdemos')),
                ('shorlisted_artist', models.ManyToManyField(blank=True, null=True, related_name='ArtistTable5', to='Artist.artisttable')),
                ('showcase_demo', models.ManyToManyField(blank=True, null=True, related_name='worklink1', to='Artist.worklink')),
            ],
        ),
        migrations.CreateModel(
            name='Project_Fee',
