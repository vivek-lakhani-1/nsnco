    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='ClientTable', to='Client_Data.clienttable')),
                ('project_demo', models.ManyToManyField(to='Artist.projectdemos')),
                ('shorlisted_artist', models.ManyToManyField(related_name='ArtistTable', to='Artist.artisttable')),
